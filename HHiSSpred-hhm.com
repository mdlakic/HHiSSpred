...
set HHISSPRED = "/home/mensur/HHiSSpred"           
set UNIPDB = "/home/mensur/db/uniprot20_02Sep11"
set HHLIB = "/home/mensur/hhsuite-2.0.15-linux-x86_64/lib/hh"

if ( "$1" == "" ) then
    echo ""
    echo " This script predicts secondary structure from HHblits alignments"
    echo " filtered to effective number of sequences = 7. Its only input is a"
    ...
    echo " Usage:"
    echo ""
    echo " HHiSSpred-hhm.com <FASTA file>"
    echo ""
    if (-e $HHISSPRED) then
...
/home/bin/hhblits -i $1 -d $UNIPDB -cpu 4 -n 3 -aliw 45 -realign_max 10000 -cov 20 -neffmax 13.0 -alt 1 -oa3m $1:r.a3m >& /dev/null
endif
if ( -e $1:r.hhr ) then
rm $1:r.hhr
endif
...
/home/mensur/HHiSSpred/bin/hhm2chk $1:r-hhm.hhm >& /dev/null
...
/home/mensur/HHiSSpred/bin/mtx2net $1:r-hhm.mtx >& /dev/null
echo " Running 1st neural network ..."
/home/mensur/HHiSSpred/bin/hhm-1st-net 315 `head -1 $1:r-hhm.mtx | awk '{print $1}'` $1:r-hhm-1st.data $1:r-hhm-1st.ss >& /dev/null
echo " Making files for 2nd neural network ..."
/home/mensur/HHiSSpred/bin/ceh2net $1:r-hhm-1st.ss >& /dev/null
echo " Running 2nd neural network ..."
/home/mensur/HHiSSpred/bin/hhm-2nd-net 60 `head -1 $1:r-hhm.mtx | awk '{print $1}'` $1:r-hhm-2nd.data $1:r-hhm-2nd.ss
echo ""
echo " Final secondary structure prediction is in $1:r-hhm-2nd.ss "
echo ""
